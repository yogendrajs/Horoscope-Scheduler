                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        <h2>We always hope <span>Better</span> for <span>You</span></h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                  ...
                  <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                      ...
                      <td valign="middle" class="bg_white footer">
                        <table>
                            ...
                            <td valign="middle" width="60%" style="padding-top: 20px; text-align: left;">
                                <h3 class="heading">Stay Updated With Your HOROSCOPE</h3>
                            </td>
                            <td valign="middle" width="40%" style="padding-top: 20px; text-align: right;">
                                <ul class="social">
                                    <a href="https://www.facebook.com/Astrologycom"><li><img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Facebook_Logo_%282019%29.png" alt="" style="width: 24px; max-width: 600px; height: auto; display: block;"></li></a>
                                    <a href="https://www.instagram.com/astrologydotcom/"><li><img src="https://www.edigitalagency.com.au/wp-content/uploads/new-instagram-logo-png-transparent-light.png" alt="" style="width: 24px; max-width: 600px; height: auto; display: block;"></li></a>
                                </ul>
                            </td>
                          </tr>
                        </table>
                    ...
                    <tr>
                      <td class="bg_light" style="text-align: center;">
                          <p>Please don't <span style="color: rgba(0,0,0,.8);">Unsubscribe </span></p>
                          <p>Made with ❤️ using <a href="https://www.npmjs.com/package/node-cron" style="color: rgba(0,0,0,.8);">Node-Cron </a> by <a href="https://github.com/yogendra3236" style="color: rgba(0,0,0,.8);">Yogendra</a></p>
                      </td>
                    </tr>
                  </table>
